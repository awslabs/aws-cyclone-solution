...
def lambda_handler(event, context):
    ...
    for record in event['Records']:
        ...
        if 'INSERT' in str(record['eventName']):

            id = record['dynamodb']['NewImage']['uuid']
            eslog = {}
            eslog['region'] = region
            eslog['eventName'] = record['eventName']
            eslog['CurrentTime'] = record['dynamodb']['NewImage']['CurrentTime']
            eslog['Status'] = record['dynamodb']['NewImage']['Status']
            eslog['id'] = record['dynamodb']['NewImage']['id']
            eslog['LeaveRunning'] = record['dynamodb']['NewImage']['LeaveRunning']
            ...
            id = record['dynamodb']['OldImage']['uuid']
            eslog = {}
            eslog['region'] = region
            eslog['eventName'] = record['eventName']
            eslog['CurrentTime'] = record['dynamodb']['OldImage']['CurrentTime']
            eslog['Status'] = record['dynamodb']['OldImage']['Status']
            eslog['id'] = record['dynamodb']['OldImage']['id']
            eslog['LeaveRunning'] = record['dynamodb']['OldImage']['LeaveRunning']
